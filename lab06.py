# # reading
# f = open("filename.txt") -- with no mode specified, it automatically reads "r"
# s = f.readlines()
# f.close()
#
# # writing
# f = open("filename.txt", "w") -- "w" overwrites the contents of the file
# f.write("Some line\n")
# f.write("Some other line\n")
# f.close()
#
# # appending
# with open("filename.txt", "a") as f: -- "a" adds to the file
#     s = f.readlines()
#     f.write("extra line\n")
...
with open("save.txt", "r") as f:
    ...
    # -1 means it will return the last line
    # strip() removes whitespaces at the beginning and end of a line
